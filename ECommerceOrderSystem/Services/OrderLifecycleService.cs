...
{
    public static bool TryValidateTransition(OrderStatus current, OrderStatus next, out string error)
    {
        error = string.Empty;
    ...
    public static IReadOnlyList<OrderStatus> GetAllowedTransitions(OrderStatus current) => current switch
    {
